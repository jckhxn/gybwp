...
__webpack_require__.d(__webpack_exports__, {
  ...
  aQ: () => (/* binding */ HERO),
  HF: () => (/* binding */ PODCAST),
  k$: () => (/* binding */ useGetEpisodesBySeason)
});

// UNUSED EXPORTS: getEpisodesBySponsor

// EXTERNAL MODULE: external "next/dist/compiled/react/jsx-runtime"
var jsx_runtime_ = __webpack_require__(56786);
// EXTERNAL MODULE: ./src/routes/index.tsx
var routes = __webpack_require__(23310);
// EXTERNAL MODULE: ./src/components/Socials/logos.tsx + 10 modules
var logos = __webpack_require__(4258);
;// CONCATENATED MODULE: ./src/components/Pages/HomePage/episode-data.tsx
// types
...
const SEASON_ONE = {
    ...
    episodes: [
        // TRAILER
        {
            ...
            episodeLinks: [
                ...
                },
                {
                    ...
                    icon: logos/* amazon */.cI.src
                }
            ],
            sponsors: [],
            image: "https://img.youtube.com/vi/6yGhUsHHh2Y/sddefault.jpg",
            url: "https://youtu.be/6yGhUsHHh2Y",
            blurb: "Season 1 of the Growing Your Business with People podcast is coming soon!"
        },
        // EPISODE ONE
        {
            uuid: "101",
            season: 1,
            episodeNumber: 1,
            episodeName: "Mastering DE&I: Foster Inclusivity At Work With David Casey",
            episodeLinks: [
                {
                    name: "apple",
            ...
            blurb: "In this episode, the host and CEO of JKL Advisors, Jeff Lackey, sits down with David Casey. David is a Chief Inclusion and Social Impact Officer with a career that spans over three decades, along with being invited to the White House on more than one occasion.",
            details: {
                featuredGuests: [
                    {
                        name: "David Casey",
                        about: "David is a Chief Inclusion and Social Impact Officer with a career that spans over three decades, along with being invited to the White House on more than one occasion.",
                        title: "Chief Inclusion and Social Impact Officer at Tapestry",
                        url: "https://www.linkedin.com/in/caseydavid/",
                        imageUrl: "https://media.licdn.com/dms/image/D4E03AQHhl85_HQk4TA/profile-displayphoto-shrink_400_400/0/1683470693299?e=1694649600&v=beta&t=oYA-tLTfc8lXGdpPW40KymTJKspOWtI-3XdZzsSOaCE"
                    }
                ],
                description: [
        ...
        // EPISODE TWO
        {
            ...
            episodeNumber: 2,
            season: 1,
            episodeName: "Revolutionise Recruitment: The Power Of Tech-Enabled Hiring Ft. Joshua Secrest",
            episodeLinks: [
                {
                    name: "apple",
            ...
            details: {
                featuredGuests: [
                    {
                        name: "Joshua Secrest",
                        about: "Joshua is the former Head of Global Talent Acquisition at McDonald's. Joshua, now at Paradox, describes how to leverage technology to drive hiring volumes while enhancing the candidate experience.",
                        title: "Vice President at Paradox",
                        url: "https://www.linkedin.com/in/joshua-secrest-44b0042/",
                        imageUrl: "https://media.licdn.com/dms/image/D5603AQHFkuHvp3TcFA/profile-displayphoto-shrink_400_400/0/1675019070527?e=1694649600&v=beta&t=jmTvCLVr7w2weI8ny5A0Vh6x5BYpBEzXWtx0giHlxvg"
                    }
                ],
                description: [],
                hashtags: [
        ...
        // EPISODE FOUR
        {
            ...
            episodeNumber: 4,
            season: 1,
            episodeName: "Leveraging Recruitment To Grow Business Ft. Dan Valavanis & Oliver Comstock",
            episodeLinks: [
                {
                    name: "apple",
        ...
        // EPISODE FIVE
        {
            ...
            episodeNumber: 5,
            season: 1,
            episodeName: "Preventing Employee Burnout: Expert Tips From Dr. Michael Halasy",
            episodeLinks: [
                {
                    name: "apple",
        ...
        // EPISODE SIX
        {
            ...
            episodeNumber: 6,
            season: 1,
            episodeName: "Successful Talent Attraction: Recruitment Secrets Revealed Ft. Craig Fisher",
            episodeLinks: [
                {
                    name: "apple",
        ...
        // EPISODE EIGHT
        {
            ...
            episodeNumber: 8,
            season: 1,
            episodeName: "How Social Media Can Transform Your Recruiting Strategies ft. CEO Amit Parmar",
            episodeLinks: [
                {
                    name: "apple",
        ...
        // EPISODE NINE
        {
            ...
            episodeNumber: 9,
            season: 1,
            episodeName: "The Importance Of Balancing People And Profit In Business Ft. Susan LaMotte",
            episodeLinks: [
                {
                    name: "apple",
        ...
        // EPISODE TEN
        {
            ...
            episodeNumber: 10,
            season: 1,
            episodeName: "Maximizing Your Hiring Success: Power Of Performance Metrics Ft. Jason Moreau",
            episodeLinks: [
                {
                    name: "apple",
        ...
        // EPISODE ELEVEN part 1
        {
            ...
            episodeNumber: 11,
            season: 1,
            episodeName: "Art of Listening: Hairdresser in the Boardroom: Insights from Kim-Adele Randall | Part 1",
            episodeLinks: [
                {
                    name: "apple",
        ...
        // EPISODE ELEVEN part 2
        {
            ...
            episodeNumber: 11,
            season: 1,
            episodeName: "Positive Self-Talk: Kim-Adele Randall Shares Her Story | Part 2",
            episodeLinks: [
                {
                    name: "apple",
        ...
        // EPISODE ELEVEN part 3
        {
            ...
            episodeNumber: 11,
            season: 1,
            episodeName: "Empowering Your Team's Strengths: Hairdresser in the Boardroom | Part 3",
            episodeLinks: [
                {
                    name: "apple",
        ...
        // EPISODE TWELVE
        {
            ...
            episodeNumber: 12,
            season: 1,
            episodeName: "Transform Your Customer Service: Expert Leadership Training with Harry Travis",
            episodeLinks: [
                {
                    name: "apple",
...
const SEASON_TWO = {
    ...
    episodes: [
        // EPISODE ONE
        {
            ...
            episodeNumber: 1,
            season: 2,
            episodeName: "Investing in Chicago's Future: Connecting Talent from Underserved Communities",
            episodeLinks: [
                {
                    name: "apple",
                ...
                featuredGuests: [
                    {
                        ...
                        about: "Hyatt President & CEO since 2006, with a daily focus on realizing Hyatt’s purpose – to care for people so they can be their best. Steadfast champion of diversity, equity and inclusion, and passionate about connecting unemployed youth with careers in hospitality. Wellbeing advocate and keen believer in the power of mindfulness and empathy. Current board chair of the American Hotel & Lodging Association and Skills for Chicagoland's Future.",
                        title: "CEO of Hyatt and chair of Skills for Chicagoland's Future",
                        url: "https://www.linkedin.com/in/mark-hoplamazian-96446b43/",
                        imageUrl: "https://media.licdn.com/dms/image/C4D03AQFVu9gZ4Kn_Qg/profile-displayphoto-shrink_400_400/0/1617899868864?e=1694649600&v=beta&t=WkauhnXOmZZ1yAzQNaDiPBKExHMdMLa6vrIPboclyfo"
                    },
                    {
                        name: "Pam Tully",
                        about: "Experienced Chief Operating Officer with a demonstrated history of working in the civic & social organization industry. Strong operations professional skilled in Budgeting, Operations Management, Team Building, Six Sigma, and Manufacturing.",
                        title: "Cheif Program Officer of Skills for Chicagoland's Future",
                        url: "https://www.linkedin.com/in/pam-tully-5765b49/",
                        imageUrl: "https://www.skillsforchicagolandsfuture.com/hs-fs/hubfs/SFC%20MJTW%20Assets/images/board-of-directors/pamela-tully-headshot.jpg?width=624&height=800&name=pamela-tully-headshot.jpg"
                    },
                    {
                        name: "Daniel Cervantes",
                        about: "Ron has had an unconventional career path, starting off as a Catholic priest before transitioning to a drug abuse counselor and eventually an intelligence officer for the government. He also served as the former CHRO of Tendergrass, a small successful company where he was able to recruit and grow his own team.",
                        title: "Senior Vice President, National Expansion and Strategic Initiatives of Skills for Chicagoland's Future",
                        url: "https://www.linkedin.com/in/daniel-cervantes-766b057",
                        imageUrl: "https://www.skillsforchicagolandsfuture.com/hs-fs/hubfs/SFC%20MJTW%20Assets/images/board-of-directors/daniel-cervantes-headshot.jpg?width=624&height=800&name=daniel-cervantes-headshot.jpg"
                    }
                ],
                description: [
                    "Jeff Lackey welcomes; Mark Hoplamazian, CEO of Hyatt and chair of Skills for Chicagoland's Future, Pam Tully, the chief program officer for Skills for Chicagoland's Future, and Daniel Cervantes, Senior Vice President, National Expansion and strategic Initiatives for Skills for Chicagoland's Future and the National Expansion Committee.",
        ...
        // EPISODE TWO
        {
            ...
            blurb: "In episode 2 of Season 2, host Jeff Lackey welcomes Ron Patrick, former head of recruitment for the CIA.",
            details: {
                featuredGuests: [
                    {
                        name: "Ronald Patrick",
                        ...
                        imageUrl: "https://media.licdn.com/dms/image/D4E03AQG6TqZnyLawaQ/profile-displayphoto-shrink_800_800/0/1680520296925?e=1694649600&v=beta&t=FqmVbvifD40zSSbN3ZKkodiV96oPRgHhpDiC5DR8KQQ"
                    }
                ],
                description: [
        ...
        // EPISODE THREE
        {
            ...
            episodeNumber: 3,
            season: 2,
            episodeName: "Leadership Insights from 50 Four-Star Generals and Admirals",
            episodeLinks: [
                {
                    name: "apple",
            ...
            blurb: "In this podcast episode of Growing Your Business with People, Jeff Lackey interviews Dr. Tom Collins, a pediatric cardiologist, professor of pediatrics, and author of a book on leadership.",
            details: {
                featuredGuests: [
                    {
                        name: "Dr. Tom Collins",
                        about: "Dr. Tom Collins is the Vice Chair of Faculty Affairs, Department of Pediatrics, at the University of Kentucky College of Medicine. He is an international expert on the cardiovascular manifestations of genetically mediated connective tissue disorders with additional expertise in leadership in medicine and physician career development.",
                        title: "Vice Chair of Faculty Affairs, Department of Pediatrics, at the University of Kentucky College of Medicine",
                        url: "https://www.linkedin.com/in/tom-collins-20137614/",
                        imageUrl: "https://media.licdn.com/dms/image/D5603AQH1cOIUUuUbFA/profile-displayphoto-shrink_800_800/0/1687275919672?e=1694649600&v=beta&t=Ly4cQM0VFsahxaWef6Sz-x9V1zHHtxiM5kssRgm6cVs"
                    }
                ],
                description: [
        ...
        // EPISODE FOUR
        {
            ...
            episodeNumber: 4,
            season: 2,
            episodeName: "HR Innovation and Business Growth With FutureSolve's COO Andy Najja",
            episodeLinks: [
                {
                    name: "apple",
            ...
            blurb: "Today on the podcast, Jeff welcomes Andy Najjar, COO of FutureSolve, an HR advisory organization with decades of experience leading innovative HR technology companies. In this episode, we explore HR innovation, business growth, and the challenges faced by organizations in managing people.",
            details: {
                featuredGuests: [
                    {
                        name: "Andy Najjar",
                        about: "Andy Najjar is responsible for leading FutureSolve's global operations with more than 15 years' experience in the talent and Human Resources space. Prior to joining FutureSolve, Andy was instrumental in growing companies like HRsmart and TalentGuard from upstart talent management software companies to acquisitions by Deltek and Venture Capital funding.",
                        title: "Chief Operating Officer at FutureSolve",
                        url: "https://www.linkedin.com/in/andynajjar/",
                        imageUrl: "https://media.licdn.com/dms/image/D5603AQHhXlMdZ2AWrg/profile-displayphoto-shrink_800_800/0/1675869531232?e=1694649600&v=beta&t=QKIaGCMAwOi2L6526h-mdqK8tPYrFhLTo1GiNKf3f0A"
                    }
                ],
                description: [
        ...
        // EPISODE FIVE
        {
            ...
            episodeNumber: 5,
            season: 2,
            episodeName: "HR Expert Ken Carrig on Building a Strong Succession Plan for Business Leaders",
            episodeLinks: [
                {
                    name: "apple",
            ...
            blurb: "In this podcast episode of Growing Your Business with People, Ken Carrig, co-founder of FutureSolve, shares his expert advice on leadership alignment and executive succession planning.",
            details: {
                featuredGuests: [
                    {
                        name: "Ken Carrig",
                        about: "Ken Carrig is the Co-Founder of FutureSolve. He advises CEOs and founders to look ahead and prepare people in their organization for what's to come. He also emphasizes the importance of letting go and growing the business with other leaders.",
                        title: "Co-Founder of FutureSolve",
                        url: "https://www.linkedin.com/in/ken-carrig-0bb4251a7",
                        imageUrl: "https://media.licdn.com/dms/image/D5610AQFMifuqUMh9wQ/image-shrink_800/0/1687571217272?e=1689307200&v=beta&t=1jzyXmE6Vj8KjIVs7SOQMFYzO5x-QPKFY9Xvr0c-zBk"
                    }
                ],
                description: [
        ...
        // EPISODE SIX
        {
            ...
            blurb: "On this podcast episode, host Jeff Lackey welcomes guest Bob Darin.",
            details: {
                featuredGuests: [
                    {
                        name: "Bob Darin",
                        about: "Bob Darin is the CEO of Blue Health Intelligence, and has a background in health care analytics. He has been in the field for close to three decades, working with large datasets and coding.",
                        title: "CEO of Blue Health Intelligence",
                        url: "https://www.linkedin.com/in/bob-darin-2a3ab96/",
                        imageUrl: "https://media.licdn.com/dms/image/D5603AQED1H7EgBR1SQ/profile-displayphoto-shrink_800_800/0/1666652600932?e=1694649600&v=beta&t=ZHbbuMK9AR_5FzZkC5dzbLyiLt1CIZyEpajehYB1hwA"
                    }
                ],
                description: [
                ...
                links: [
                    ...
                    },
                    {
                        ...
                        linkUrl: "https://www.linkedin.com/company/blue-health-intelligence/"
                    },
                    {
                        text: "For more information, visit:",
        ...
        // EPISODE SEVEN
        {
            ...
            episodeNumber: 7,
            season: 2,
            episodeName: "Strategic Talent Consulting & HR Value Creation in Business with Tom Corbitt",
            episodeLinks: [
                {
                    name: "apple",
            ...
            blurb: "In this podcast episode, host Jeff Lackey welcomes Tom Corbitt, the founder and managing partner of Top Line Growth Partners. The two discuss the importance of identifying discrete problems and understanding the timetable for affecting change in skill level, behavior, and time to fill vacant roles.",
            details: {
                featuredGuests: [
                    {
                        name: "Tom Corbitt",
                        about: "Tom is a skilled facilitator, coach, and leader who acts as an extension of his client’s senior staff. In this capacity, he provides the expertise and incremental bandwidth to help them lead their organizations through major transformation. He understands how to align strategy, process, technology, talent and culture to help his clients achieve a sustainable step function increase in organizational capability.",
                        title: "Founder and Managing Partner of Top Line Growth Partners",
                        url: "https://www.linkedin.com/in/tom-corbitt-0b4b546/",
                        imageUrl: "https://media.licdn.com/dms/image/C4D03AQHC-hjLncwNLg/profile-displayphoto-shrink_400_400/0/1632176543961?e=1694649600&v=beta&t=5fXVyf-0K30FfjiNSrUK4i1VKweNp-qrTDBsSEiFoWI"
                    }
                ],
                description: [
        ...
        // EPISODE EIGHT
        {
            ...
            episodeNumber: 8,
            season: 2,
            episodeName: "College Recruiter Founder Steven Rothberg: Early Career Hiring & Talent Attraction Strategies",
            episodeLinks: [
                {
                    name: "apple",
        ...
        // EPISODE NINE
        {
            ...
            episodeNumber: 9,
            season: 2,
            episodeName: "Expert HR Insights: Talent Management & Leadership With Mark Griffin",
            episodeLinks: [
                {
                    name: "apple",
            ...
            blurb: "In this podcast episode, host Jeff Lackey interviews Mark Griffin, Executive Vice President, Chief Human Resources Officer at BJ's Wholesale Club and former Senior Vice President of HR at CVS Health.",
            details: {
                featuredGuests: [
                    {
                        name: "Mark Griffin",
                        about: "Mark Griffin is a top HR executive with Fortune 10 experience leading large teams of human resources professionals. He has deep knowledge of all areas of HR and proven track record of driving business results through human capital strategies.",
                        title: "Executive Vice President, Chief Human Resources Officer at BJ's Wholesale Club",
                        url: "https://www.linkedin.com/in/mark-griffin-3096381/",
                        imageUrl: "https://media.licdn.com/dms/image/C4D03AQHFQkDl3CHFiA/profile-displayphoto-shrink_800_800/0/1645884105228?e=1694649600&v=beta&t=Lc4OxVT1X6qqEY4icC6szYRYwfCuD3Pf_ItZ_jV_zjs"
                    }
                ],
                description: [
        ...
        // EPISODE TEN
        {
            ...
            episodeNumber: 10,
            season: 2,
            episodeName: "Maximizing Business Growth with Data Analysis with Amy Bush",
            episodeLinks: [
                {
                    name: "apple",
            ...
            blurb: "In this episode of the Growing Your Business with People podcast, host Jeff Lackey welcomes the president of Sevenstep, Amy Bush. They discuss the importance of data-driven decision-making and how leaders can use data to guide their talent acquisition process.",
            details: {
                featuredGuests: [
                    {
                        name: "Amy Bush",
                        about: "Amy Bush is an innovative leader, committed to empowering and mentoring young professionals as they build their careers and grow into the next generation. She is a dynamic leader of a global team delivering talent-focused client solutions in 75+ countries across the Americas, EMEA and APAC.",
                        title: "President of Sevenstep",
                        url: "https://www.linkedin.com/in/amybbush/",
                        imageUrl: "https://media.licdn.com/dms/image/C4E03AQHi9Vu5u8BRzA/profile-displayphoto-shrink_800_800/0/1516220281240?e=1694649600&v=beta&t=u3hLFFk8t0GqQOPUqugTp5NzRFDuUz6XplH5MasYIYo"
                    }
                ],
                description: [
        ...
        // EPISODE ELEVEN
        {
            ...
            episodeNumber: 11,
            season: 2,
            episodeName: "Revolutionizing Employee Referral Programs w/ Real Links CEO Sam Davies",
            episodeLinks: [
                {
                    name: "apple",
            ...
            blurb: "In this podcast episode, host Jeff Lackey and CEO of Real Links, Sam Davies, discuss the benefits of employee referrals in hiring. Jeff and Sam also talk about the importance of networking and employee brand activation as a critical aspect of successful hiring.",
            details: {
                featuredGuests: [
                    {
                        name: "Sam Davies",
                        about: "Sam Davies is the CEO & Co-Founder of Real Links. He emphasizes the need for engagement strategies to support referral and advocacy efforts, targeting specific areas for referrals, such as tech hiring, to maximize cost savings and engagement.",
                        title: "CEO & Co-Founder at Real Links",
                        url: "https://www.linkedin.com/in/samgtdavies/",
                        imageUrl: "https://www.inhouserecruitment.co.uk/wp-content/uploads/2019/12/Sam-real-links-e1595231963692.jpeg"
                    }
                ],
                description: [
                    ...
                    "Sam shares examples that highlight the potential cost savings of up to \xa3100,000 in six months and the positive impact on productivity and retention levels compared to other recruitment channels.",
        ...
        // EPISODE ELEVEN | SHORT 1
        {
            ...
            episodeNumber: 11,
            season: 2,
            episodeName: "Tech Hiring as an Example to Improve Recruitment Strategies w/ Real Links CEO Sam Davies",
            sponsors: [
                "sevenstep",
                "bayard",
                "paradox",
        ...
        // EPISODE TWELVE
        {
            ...
            episodeNumber: 12,
            season: 2,
            episodeName: "Thoughtful Leadership, Finding Organizational Purpose w/ Helena Foulkes",
            episodeLinks: [
                {
                    name: "apple",
        ...
        // EPISODE TWELVE | SHORT 1
        {
            ...
            episodeNumber: 12,
            season: 2,
            episodeName: "Helena Foulkes Shares the Story Behind How CVS Quit Smoking",
            sponsors: [
                "sevenstep",
                "bayard",
                "paradox",
...
const SEASON_THREE = {
    ...
    episodes: [
        // EPISODE ONE
        {
            ...
            episodeNumber: 1,
            season: 3,
            episodeName: "Prioritizing People & Managing Attrition with Former CVS Executive, Dr. Alan Lotvin",
            episodeLinks: [
                {
                    name: "apple",
            ...
            blurb: "Dr. Alan Lotvin shares his insights on leadership and growing a business with people. He emphasizes the importance of taking a chance on people and recognizing patterns of success. He discusses the need to prioritize talent and culture as a leader and shares his approach to reducing attrition. Dr. Lotvin also highlights the importance of honest conversations and developing individuals' talents.",
            details: {
                featuredGuests: [
                    {
                        name: "Dr. Alan Lotvin",
                        about: "Dr. Alan Lotvin is a renowned cardiologist, author, and executive leader. He has had a diverse and exciting career, including serving as the president of CVS Caremark, where he helped transform the company into a formidable healthcare organization. He is known for his expertise in healthcare management and his ability to lead high-performing teams.",
                        title: "Former Executive Vice President of CVS Health and Former President of CVS Caremark",
                        url: "https://www.linkedin.com/in/alanlotvin/",
                        imageUrl: "https://pbs.twimg.com/profile_images/1583170525928558592/gh35Fzj3_400x400.jpg"
                    }
                ],
                description: [
        ...
        // EPISODE TWO
        {
            ...
            episodeNumber: 2,
            season: 3,
            episodeName: "Creating a Culture of Belonging is Good Business w/ William Arruda & Sondra Dryer",
            episodeLinks: [
                {
                    name: "apple",
            ...
            blurb: "In our recent episode, guest William Arruda highlighted the data that supports the need to emphasize belonging in the workplace.",
            details: {
                featuredGuests: [
                    {
                        name: "William Arruda",
                        about: "William Arruda is a personal branding pioneer and the founder of CareerBlast.TV. He has written nearly 700 articles for Forbes and other publications and is an expert in personal branding.",
                        title: "Co-Founder of CareerBlast and Motivational Speaker",
                        url: "https://www.linkedin.com/in/williamarruda/",
                        imageUrl: "https://williamarruda.com/wp-content/uploads/2021/03/PORTRAIT3.jpg"
                    },
                    {
                        name: "Sondra Dryer",
                        about: "Sondra helps companies articulate their unique employee value proposition (EVP) to attract key talent while simultaneously activating their own employees to become their brand ambassadors. Her specialties include: employer brand strategy, recruitment marketing, employee communications and engagement, public relations, cultural integration, public speaking, leadership development and team building.",
                        title: "President and Senior Employer Brand Strategist at Spark Employer Brand Consulting",
                        url: "https://www.linkedin.com/in/sondradryer/",
                        imageUrl: "https://media.licdn.com/dms/image/C4E03AQExI-TztV2Ohw/profile-displayphoto-shrink_800_800/0/1613094682102?e=1695254400&v=beta&t=sNDbyjdoqciXdJgHYHHrLTg5VNMXwLEwntdCs8ASweI"
                    }
                ],
                description: [
        ...
        // EPISODE THREE
        {
            ...
            episodeNumber: 3,
            season: 3,
            episodeName: "Harnessing Strengths to Drive Employee Engagement & Retention",
            episodeLinks: [
                {
                    name: "apple",
            ...
            blurb: "This week on the Growing Your Business with People podcast, LeAnne Lagasse discusses the importance of playing to your team's strengths and developing your people managers. She emphasizes the need for leaders to set the tone for owning strengths and weaknesses and creating a culture of continuous improvement.",
            details: {
                featuredGuests: [
                    {
                        name: "LeAnne Lagasse",
                        about: "CEO of LeAnne Lagasse Coaching and Consulting LLC. She is an HR consultant and keynote speaker who helps leaders and organizations improve employee engagement and retention.",
                        title: "HR and People Ops Consulting at LeAnne Lagasse Coaching and Consulting",
                        url: "https://www.linkedin.com/in/leannelagasse/",
                        imageUrl: "https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/themes/2150450831/settings_images/VWKZGgToQt6I2WvK8AnC_file.jpg"
                    }
                ],
                description: [
                ...
                links: [
                    ...
                    },
                    {
                        ...
                        linkUrl: "https://hbr.org/2023/03/it-takes-versatility-to-lead-in-a-volatile-world",
        ...
        // EPISODE FOUR
        {
            ...
            episodeNumber: 4,
            season: 3,
            episodeName: "Matt Alder, Future of Talent Acquisition: AI & Recruiter-less Hiring",
            episodeLinks: [
                {
                    name: "apple",
                    link: "https://podcasts.apple.com/us/podcast/harnessing-strengths-to-drive-employee-engagement-retention/id1659743511?i=1000621488991",
        ...
        },
        {
            ...
            blurb: "Dive into the transformative world of HR with Toby Barnes as he sheds light on the pivotal role of HR Business Partners. A must-watch for CEOs, HR leaders, and anyone passionate about organizational success.",
            details: {
                featuredGuests: [
                    {
                        name: "Toby Barnes",
                        about: "Experienced talent acquisition and recruitment professional. Toby has worked in various roles in talent acquisition and resourcing for companies such as Rolls-Royce, TFL Transport for London, Google, and Travis Perkins.",
                        title: "Producer & Host",
                        url: "https://www.linkedin.com/in/tobyjbarnes/",
                        imageUrl: "https://media.licdn.com/dms/image/D4E03AQEWw4-CRYtm9A/profile-displayphoto-shrink_800_800/0/1690304320810?e=1698278400&v=beta&t=1sHj3dX098oJHTOkHGCsLDbwQVw8OU1hy5eOAasVeJQ"
                    }
                ],
                description: [
                ...
                links: [
                    {
                        text: "LEGO\xae Rolls-Royce Trent 1000 Jet Engine - Bright Bricks Timelapse",
        ...
        },
        {
            ...
            episodeNumber: 7,
            season: 3,
            episodeName: "The Future of Work: Embracing AI and the Gig Economy w/ Mark Judd",
            episodeLinks: [
                {
                    name: "apple",
            ...
            blurb: "Jeff Lackey has a conversation with Mark Judd about impact of advanced technology, such as artificial intelligence (AI), on human capital management (HCM) and the future of work.",
            details: {
                featuredGuests: [
                    {
                        name: "Mark Judd",
                        about: "Mark Judd is an experienced business leader with a background in human resources. He has worked for companies such as Toyota, P.W. See, Rolls-Royce, and Workday. He is currently a visiting researcher at Lancaster University, where he focuses on artificial intelligence, human capital management, and the ethics surrounding these areas.",
                        title: "Producer & Host",
                        url: "https://www.linkedin.com/in/mark-judd-74a6b89/",
                        imageUrl: "https://media.licdn.com/dms/image/C4E03AQHyc2bdYuXPvg/profile-displayphoto-shrink_800_800/0/1643327289946?e=1698278400&v=beta&t=VquiN1JVCyZLzGMCQ_hpY34Z0NIT1VjYD_Dul2xqesQ"
                    }
                ],
                description: [
                ...
                links: [
                    {
                        ...
                        linkUrl: "https://www.forbes.com/sites/forbeshumanresourcescouncil/2023/05/04/change-at-the-speed-of-ai-the-latest-human-capital-disrupter/?sh=5449f7e22fb2"
                    },
                    {
                        text: "AI in the workplace.",
                        linkUrl: "https://www.kornferry.com/insights/featured-topics/gen-ai-in-the-workplace?utm_source=google&utm_medium=ppc&utm_campaign=23-08-gbl-misc&utm_term=ai_in_the_workplace&utm_content=capability-page&gad=1"
                    },
                    {
                        text: "Artifical Intelligence in Human Capital Management",
                        linkUrl: "https://www.oracle.com/a/ocom/docs/dc/lpd100770849-capstoneinsightsaiinhcm.pdf"
                    }
                ]
            }
        },
        {
            ...
            blurb: "In this episode of the Growing Your Business with People podcast, Rob McIntosh shares his passion for talent acquisition data and how it can drive business growth.",
            details: {
                featuredGuests: [
                    {
                        name: "Rob Mcintosh",
                        about: "Rob McIntosh is an industry analyst and former talent acquisition leader for companies such as Microsoft, Deloitte, and McKesson. He is the co-founder of SourceCon, the industry's preeminent sourcing community, and is currently the VP of Recruiting Solutions at PSG Global Solutions.",
                        title: "Industry Analyst",
                        url: "https://www.linkedin.com/in/robmcintosh/",
                        imageUrl: "https://media.licdn.com/dms/image/C4E03AQGiDvnhneg1eA/profile-displayphoto-shrink_800_800/0/1558385926308?e=1698883200&v=beta&t=IQ9dUQEvvMytnTs1ur_v_1Djp2B6KfS-15fEhvVsQTU"
                    }
                ],
                description: [
        ...
        },
        {
            ...
            episodeNumber: 9,
            season: 3,
            episodeName: "Design Thinking and Employee Experience: Creating a Competitive Advantage",
            episodeLinks: [
                {
                    name: "apple",
            ...
            blurb: "Jon Brickner, the leader of the Employee Experience Design Practice at Steelcase, joins host Jeff Lackey to discuss the importance of employee experience and how it can help businesses grow.",
            details: {
                featuredGuests: [
                    {
                        name: "Jon Brickner",
                        about: "Jon Brickner is the leader of the Employee Experience Design Practice at Steelcase. With over 17 years of experience in strategic HR and design thinking, Jon brings a unique perspective to workplace challenges. He is passionate about creating engaging experiences for employees and helping businesses grow.",
                        title: "Employee Experience Design Practice at Steelcase",
                        url: "https://www.linkedin.com/in/jonbrickner/",
                        imageUrl: "https://media.licdn.com/dms/image/D5603AQHSNPMiRKm0uA/profile-displayphoto-shrink_800_800/0/1681744770204?e=1699488000&v=beta&t=5rtvKXYAO-e4cP5j2yXFX7194M0C3JZ6CFnup3cZEFY"
                    }
                ],
                description: [
                ...
                links: [
                    {
                        ...
                        linkUrl: "He emphasizes the need for leaders to invest in their people and create a culture of prototyping, testing, and scaling."
                    }
                ]
            }
        },
        {
            ...
            details: {
                featuredGuests: [
                    {
                        name: "Dennis Berger",
                        about: "Dennis Berger is an experienced HR executive who has held leadership positions at companies such as Pepsi, CDW, AutoNation, and Suffolk. With over 34 years of experience in HR, Dennis has a deep understanding of the importance of frontline leadership and the impact it can have on an organization's success.",
                        title: "Experienced CHRO | CDW, AutoNation, Suffolk",
                        url: "https://www.linkedin.com/in/dennis-g-berger/",
                        imageUrl: "https://media.licdn.com/dms/image/C4D03AQG8GwQcNOrvnQ/profile-displayphoto-shrink_400_400/0/1591893899126?e=1700092800&v=beta&t=0bj5B7L7bkQ8TwsIhOOmFBuw9WCuFfaCARZK8VtJmkM"
                    }
                ],
                description: [
                ...
                links: [
                    {
                        ...
                        linkUrl: "https://www.forbes.com/sites/brucetulgan/2021/03/05/listen-to-your-employees-if-you-want-to-take-care-of-them/?sh=70dabaf140d5"
                    }
                ]
            }
        }
...
;// CONCATENATED MODULE: ./src/components/Pages/HomePage/static-data.tsx
// @ts-nocheck
...
const static_data_client = (0,client/* createClient */.e)({
    projectId: "hxymd1na",
    dataset: "production",
...
const HERO = {
    ...
    buttonUrl: routes/* default */.Z.external.subscribe,
    secondButtonText: "Listen Now",
    secondButtonUrl: routes/* default */.Z.external.listen
};
const CTA = {
    ...
    buttonUrl: routes/* default */.Z.external.newsletter
};
const PODCAST = [
    SEASON_ONE,
    SEASON_TWO,
...
const useGetEpisodesBySeason = (seasonToFind)=>{
    const { data, error, isLoading } = (0,dist/* default */.ZP)(groq/* default */.Z`*[_type == "episode"] | order(uuid asc)`, (query)=>static_data_client.fetch(query));
    ...
    const episodesArray = Object.keys(data).filter((key)=>key !== "_persist").map(function(property) {
        return data[property];
    });
    const foundSeason = episodesArray.filter(// @ts-ignore
    (season)=>season.seasonNumber === seasonToFind);
    return [
        ...foundSeason
    ].reverse();
};
const getEpisodesBySponsor = (uuid, episodesData)=>{
