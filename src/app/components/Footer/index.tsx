...
const Footer = () => {
  ...
  return (
    <footer aria-label="Site Footer" className="bg-white">
      <nav aria-label="Footer Nav" className="my-8 mx-8 md:mx-4 pt-16">
        <ul className="flex flex-wrap justify-evenly gap-4 md:gap-0 items-center text-center">
          <li className="md:w-[12vw]">
            <Link
              className="text-gray-700 transition hover:text-gray-700/75"
              href={routes.internal.news}
            >
              News
            </Link>
          </li>
          ...
          <li className="hidden lg:flex justify-center mx-2 w-[13vw] m-auto">
      ...
      <div className="pb-16">
        <p className="text-center text-xs/relaxed text-gray-500">
          © JKL Advisors, LLC. {calculateDate()}. We love our subscribers!
        </p>
      </div>
    </footer>
  );
