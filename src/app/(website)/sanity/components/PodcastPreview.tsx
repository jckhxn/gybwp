...
// components
import { Section, SectionHeading } from "@/src/app/(website)/components/shared";
import Image from "next/image";
import Button from "@/src/app/(website)/components/Button";
import Socials from "@/src/app/(website)/components/Socials";
import Link from "next/link";
import Slider from "@/src/app/(website)/components/Slider";
import { formatEpisodeTitle } from "@/src/lib/formatTitle";
// BuzzSprout Player
import { BuzzSproutPlayer } from "@/src/app/(website)/components/BuzzSproutPlayer";

import {
  DATA,
  CTA,
} from "../../components/Pages/PodcastDetailsPage/static-data";
