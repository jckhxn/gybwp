...
export default function ModernConsultingPage() {
  return (
    <main className="w-full">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-200 leading-relaxed">
                  Transform your organization through strategic talent solutions. 
                  With 28+ years of experience and over 1 million successful hires, 
                  we help businesses grow through their most important investment: people.
                </p>
              </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From strategic planning to execution, we provide end-to-end consulting 
              services that drive sustainable business growth through people.
            </p>
          </div>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  Within the Consulting practice of JKL Advisors, we help CEOs and business 
                  leaders grow their business with the biggest and most important investment - People!
                </p>
                <p className="text-lg text-gray-600 leading-relaxed">
                  Unlike financial accounting that treats people as expenses, we believe people 
                  are a special asset type that anticipates growth. We need to treat our people 
                  like an investment to lead our companies to exponential and sustainable growth.
                </p>
              </div>
            ...
            <div className="relative order-2 lg:order-1">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white rounded-xl p-6 shadow-xl max-w-xs">
                ...
                <p className="text-sm text-gray-600">
                  &quot;Jeff&apos;s strategic approach transformed our talent acquisition process.&quot;
                </p>
            ...
            <div className="space-y-8 order-1 lg:order-2">
              ...
              <div className="space-y-6 text-gray-300">
                <p className="text-lg leading-relaxed">
                  As a global strategic talent leader, I continually seek to remain ahead of 
                  technology and innovation trends. I immerse myself in interactions with thought 
                  leaders and experts to explore new applications beyond the TA realm.
                </p>
                <p className="text-lg leading-relaxed">
                  At JKL Advisors, we empower YOUR business with people. With 28+ years and 
                  hiring over 1 million professionals, we&apos;re poised to help you attract, 
                  develop, and retain top talent. Our value creation framework strengthens 
                  operations while fostering innovative, growth-driven solutions.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center p-4 bg-gray-800 rounded-lg">
                  ...
                  <div className="text-sm text-gray-400">Professionals Hired</div>
                </div>
                <div className="text-center p-4 bg-gray-800 rounded-lg">
      ...
      {/* Contact Section */}
      <section id="contact" className="py-20 lg:py-32 bg-gradient-to-br from-gray-800 via-gray-900 to-black">
        <div className="container px-4 md:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              ...
              Schedule a consultation with Jeff today.
            </p>
          </div>
