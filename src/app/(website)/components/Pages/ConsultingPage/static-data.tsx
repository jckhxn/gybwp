  ...
  bullets: [
    {
      ...
      text: "Maximizing Organizational Performance",
    },
    {
      icon: (
        <span className="float-left mr-3">
      ...
      text: "Leadership and Talent Development",
    },
    {
      icon: (
        <span className="float-left mr-3">
      ...
      text: "Creating High-Performance Cultures",
    },
  ],
};
