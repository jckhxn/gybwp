  ...
  return (
    <>
      <section className="relative w-full py-16 md:py-20 flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute -left-8 top-1/4 w-32 h-32 bg-primary/2 rounded-full blur-2xl"></div>
        <div className="absolute -right-8 bottom-1/4 w-40 h-40 bg-secondary/2 rounded-full blur-2xl"></div>
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-7xl relative z-10">
          <div className="flex flex-col items-center gap-6 md:gap-8 text-center">
            ...
            <div className="grid gap-12 lg:grid-cols-2 p-8 md:p-10 bg-white rounded-xl border border-gray-100 relative z-10 w-full max-w-6xl">
