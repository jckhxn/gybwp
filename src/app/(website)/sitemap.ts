// Sanity
import type { EpisodeType as BaseEpisodeType } from "@/types";
import { client } from "./sanity/sanity-utils";

import { ALL_EPISODES } from "./lib/queries";

// Extend for sitemap usage
interface EpisodeTypeForSitemap extends BaseEpisodeType {
...
export default async function sitemap() {
  ...
  const episodeUrls = episodes.map((episode: EpisodeTypeForSitemap) => ({
