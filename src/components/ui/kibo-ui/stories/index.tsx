...
export const Story = ({ className, ...props }: StoryProps) => (
  <CarouselItem className={cn("min-w-0 shrink-0 grow-0 basis-auto pl-2 md:pl-4", className)}>
    <div
      className={cn(
        "group relative overflow-hidden rounded-xl bg-gray-100/40 dark:bg-gray-800/40",
...
export const StoryAuthorImage = ({
  ...
  <Avatar className={cn("size-6 border border-gray-200 border-white/20 dark:border-gray-800", className)} {...props}>
