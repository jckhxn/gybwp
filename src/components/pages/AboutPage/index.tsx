        ...
        <div className="container mx-auto px-6 max-w-5xl grid md:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col items-center text-center bg-white rounded-2xl p-8 border border-gray-200/70 shadow-lg">
            <div className="relative mb-6">
              <div className="absolute -inset-3 bg-primary/15 rounded-full blur-lg opacity-30"></div>
              <Image
...
function PlatformBadge({
  ...
  return (
    <Link
      href={href}
      className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 hover:bg-primary/20 text-primary hover:text-primary/80 rounded-lg border border-primary/20 hover:border-primary/30 transition-all duration-200"
