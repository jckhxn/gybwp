          ...
          >
            <Stack space={4} padding={4}>
              ...
              <FormField title="Description">
                <TextArea value={props.details.description} rows={10} />
              </FormField>
              <FormField title="Published Date">
                <TextInput
                  readOnly
                  value={formatDateTime(props.details.publishedAt)}
                />
              </FormField>
              <FormField title="Thumbnail">
                <TextInput readOnly value={props.details.thumbnail} />
              </FormField>
            </Stack>
          </Dialog>
        )}
