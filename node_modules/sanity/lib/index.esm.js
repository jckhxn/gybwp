...
import { C as ConnectorContext, u as useReporter, S as ScrollContext, r as resizeObserver, a as useReportedValues, b as SvgWrapper, c as Connector, D as DEBUG_LAYER_BOUNDS, i as isNonNullable$1, T as Tracker, d as ScrollContainer, e as useUserColorManager, f as useTranslation, g as getAnnotationColor, h as DiffTooltip, j as Checkbox, F as FromToArrow, P as Preview, k as DiffFromTo, l as SlugPreview, m as StringPreview, n as DatetimeFieldDiff, p as pathToString, H as HoveredFieldContext, o as FormFieldPresenceContext, A as ArrayOfObjectsItem, M as MemberItemError, R as ReviewChangesContext, q as defaultResolveAnnotationComponent, s as defaultResolveBlockComponent, t as defaultResolveInlineBlockComponent, v as defaultResolveFieldComponent, w as defaultResolveInputComponent, x as defaultResolveItemComponent, y as ArrayOfObjectsFunctions, z as DefaultMarkers, B as FormBuilderContext, E as FormCallbacksProvider, G as DocumentIdProvider, I as PresenceProvider, V as ValidationProvider, J as EMPTY_ARRAY$2, K as useSource, L as useInputComponent, N as useFieldComponent, O as usePreviewComponent, Q as useItemComponent, U as useBlockComponent, W as useInlineBlockComponent, X as useAnnotationComponent, Y as PreviewLoader, Z as PatchEvent, _ as GetFormValueProvider, $ as FormValueProvider, a0 as DocumentFieldActionsProvider, a1 as memoize, a2 as memoizeKeyGen, a3 as memoizedPair, a4 as validateTemplates, a5 as isBuilder, a6 as useDocumentStore, a7 as getPublishedId, a8 as useHistoryStore, a9 as useClient, aa as DEFAULT_STUDIO_CLIENT_OPTIONS, ab as useWorkspace, ac as useProjectStore, ad as prepareConfig, ae as AddonDatasetContext, af as StudioProvider, ag as GlobalStyle, ah as StudioLayout, ai as useListFormat, aj as intlCache, ak as useRelativeTime, al as useUserStore, am as grantsPermissionOn, an as HookStateContainer, ao as useReferringDocuments, ap as ZIndexContext, aq as defaults, ar as getFieldLevel, as as isRecord, at as useCurrentUser, au as immutableReconcile, av as isMemberArrayOfObjects, aw as isMemberObject, ax as SANITY_PATCH_TYPE } from "./_legacy/_internalBrowser.esm.js";
import { ep, eq, cd, c9, ce, cf, c7, cg, cu, b2, c8, aN, aO, ci, dF, bk, az, bl, bm, bn, aR, b1, b3, ex, ew, ev, eu, et, aA, aJ, b5, b6, aB, dI, cN, f9, fi, cj, ck, aK, aL, bo, bB, bp, bq, bs, br, bC, di, aC, aD, fu, cl, e_, bt, c1, c2, c3, bu, dm, dj, dk, dl, cP, cJ, bW, bX, bY, bZ, b_, b$, bv, bw, cQ, aZ, aP, aE, a_, aS, aF, db, dc, aM, cv, cw, cx, bx, eS, by, cm, cn, cy, cz, cA, dn, aG, c8 as c82, dp, aI, cO, cM, el, bz, fI, ei, du, bb, eM, eH, eN, eF, eI, eG, co, cp, eR, aW, cq, eT, eO, eP, cr, aQ, cs, aX, ee, ef, eQ, aY, c_, dh, ch, eY, eV, eX, eW, eU, ct, a$, fg, bA, ca, cc, f0, eZ, f7, f8, ej, dA, ez, fF, dQ, fs, dB, dO, dH, dv, dW, fp, e8, ed, fh, dz, dP, ek, fr, dx, fx, aT, aU, ff, en, cH, dg, fd, d7, d8, d9, eD, eE, eL, cF, b8, fj, dR, dS, fz, fy, bL, b9, bf, bg, e2, e5, fo, fm, dZ, bS, bT, f2, dX, dq, dr, ds, dC, dy, e9, bK, bV, f1, fv, cG, b7, cC, bG, cX, cW, cY, dD, cV, dE, bc, fk, fl, bU, bE, bF, cU, cS, cR, bd, fn, bH, fw, cT, bI, fA, d_, er, fq, bD, bO, bQ, bP, bN, dG, dT, eK, bR, cI, dt, ft, ec, da, bJ, fa, fb, fc, ba, cD, cB, fC, dU, bM, fB, fD, cE, dw, df, es, bi, eB, eC, ey, eA, dL, c$, d0, c6, bj, be, d1, e4, e3, eg, dK, e7, e6, dY, d2, c4, cZ, cK, c0, dd, eh, dJ, c5, de, d$, e0, dN, fE, b4, dM, aH, d3, cL, e1, em, aV, d4, eJ, eb, ea, d5, fH, d6, eo, fe, cb, e$, f3, b0, fG, f6, ay, f5, f4, dV, bh } from "./_legacy/_internalBrowser.esm.js";
...
import { u as useCurrentLocale, B as Button } from "./_legacy/generate-help-url.esm.esm.js";
import { a } from "./_legacy/generate-help-url.esm.esm.js";
...
const remoteSnapshots = memoize(
  (client, idPair, typeName, serverActionsEnabled) => memoizedPair(client, idPair, typeName, serverActionsEnabled).pipe(
...
function useTimelineStore({
  ...
  const historyStore = useHistoryStore(), snapshotsSubscriptionRef = useRef(null), timelineStateRef = useRef(INITIAL_TIMELINE_STATE), client = useClient(DEFAULT_STUDIO_CLIENT_OPTIONS), workspace = useWorkspace(), serverActionsEnabled = useMemo(() => {
    var _a;
    return !!((_a = workspace.serverActions) != null && _a.enabled);
  }, [workspace]), controller = useMemo(
  ...
  }), [client, controller, documentId, documentType, serverActionsEnabled]), useMemo(() => ({
...
export {
  ep as ActiveWorkspaceMatcher,
  eq as ActiveWorkspaceMatcherContext,
  AddonDatasetContext,
  AddonDatasetProvider,
  cd as ArrayOfObjectOptionsInput,
  ArrayOfObjectsFunctions,
  c9 as ArrayOfObjectsInput,
  ArrayOfObjectsInputMember,
  ArrayOfObjectsInputMembers,
  ArrayOfObjectsItem,
  ce as ArrayOfOptionsInput,
  cf as ArrayOfPrimitiveOptionsInput,
  c7 as ArrayOfPrimitivesFunctions,
  cg as ArrayOfPrimitivesInput,
  cu as ArrayOfPrimitivesItem,
  b2 as AutoCollapseMenu,
  BetaBadge,
  c8 as BlockEditor,
  aN as BlockImagePreview,
  aO as BlockPreview,
  ci as BooleanInput,
  dF as CONNECTING,
  bk as ChangeBreadcrumb,
  ChangeConnectorRoot,
  ChangeFieldWrapper,
  az as ChangeIndicator,
  bl as ChangeList,
  bm as ChangeResolver,
  bn as ChangeTitleSegment,
  aR as CircularProgress,
  b1 as CollapseMenu,
  b3 as CollapseMenuButton,
  ex as ColorSchemeCustomProvider,
  ew as ColorSchemeLocalStorageProvider,
  ev as ColorSchemeProvider,
  eu as ColorSchemeSetValueContext,
  et as ColorSchemeValueContext,
  aA as CommandList,
  aJ as CompactPreview,
  b5 as ConfigPropertyError,
  b6 as ConfigResolutionError,
  ConnectorContext,
  aB as ContextMenuButton,
  dI as CorsOriginError,
  cN as CrossDatasetReferenceInput,
  f9 as DEFAULT_MAX_RECURSION_DEPTH,
  DEFAULT_STUDIO_CLIENT_OPTIONS,
  fi as DRAFTS_FOLDER,
  cj as DateInput,
  ck as DateTimeInput,
  DefaultDocument,
  aK as DefaultPreview,
  aL as DetailPreview,
  bo as DiffCard,
  bB as DiffContext,
  bp as DiffErrorBoundary,
  DiffFromTo,
  bq as DiffInspectWrapper,
  bs as DiffString,
  br as DiffStringSegment,
  DiffTooltip,
  DisabledChangeConnectorRoot,
  bC as DocumentChangeContext,
  di as DocumentPreviewPresence,
  aC as DocumentStatus,
  aD as DocumentStatusIndicator,
  ...
  e_ as ErrorMessage,
  bt as FallbackDiff,
  c1 as FieldActionMenu,
  c2 as FieldActionsProvider,
  c3 as FieldActionsResolver,
  bu as FieldChange,
  dm as FieldPresence,
  dj as FieldPresenceInner,
  dk as FieldPresenceWithOverlay,
  dl as FieldPresenceWithoutOverlay,
  cP as FileInput,
  FormBuilder,
  FormBuilderContext,
  cJ as FormCallbacksContext,
  FormCallbacksProvider,
  bW as FormField,
  bX as FormFieldHeaderText,
  FormFieldPresenceContext,
  bY as FormFieldSet,
  bZ as FormFieldStatus,
  b_ as FormFieldValidationStatus,
  b$ as FormInput,
  FormProvider,
  FormValueProvider,
  bv as FromTo,
  ...
  cQ as ImageInput,
  aZ as ImperativeToast,
  aP as InlinePreview,
  aE as InsufficientPermissionsMessage,
  IntentButton,
  a_ as LegacyLayerProvider,
  aS as LinearProgress,
  aF as LoadingBlock,
  db as LocaleProvider,
  dc as LocaleProviderBase,
  aM as MediaPreview,
  cv as MemberField,
  cw as MemberFieldError,
  cx as MemberFieldSet,
  MemberItemError,
  bx as MetaInfo,
  eS as NavbarContext,
  by as NoChanges,
  cm as NumberInput,
  cn as ObjectInput,
  cy as ObjectInputMember,
  cz as ObjectInputMembers,
  cA as ObjectMembers,
  dn as OverlayDisabled,
  PatchEvent,
  aG as PopoverDialog,
  c82 as PortableTextInput,
  dp as PresenceOverlay,
  PresenceScope,
  Preview,
  aI as PreviewCard,
  PreviewLoader,
  cO as ReferenceInput,
  cM as ReferenceInputOptionsProvider,
  RelativeTime,
  el as ResourceCacheProvider,
  bz as RevertChangesButton,
  ReviewChangesContext,
  SANITY_PATCH_TYPE,
  fI as SANITY_VERSION,
  ei as SESSION_ID,
  du as SanityDefaultPreview,
  bb as SchemaError,
  ScrollContainer,
  ScrollMonitor,
  eM as SearchButton,
  ...
  eN as SearchDialog,
  eF as SearchPopover,
  eI as SearchProvider,
  eG as SearchResultItemPreview,
  co as SelectInput,
  cp as SlugInput,
  eR as SourceProvider,
  aW as StatusButton,
  cq as StringInput,
  Studio,
  StudioLayout,
  eT as StudioLayoutComponent,
  StudioLogo,
  eO as StudioNavbar,
  StudioProvider,
  eP as StudioToolMenu,
  cr as TagsArrayInput,
  TelephoneInput,
  aQ as TemplatePreview,
  cs as TextInput,
  aX as TextWithTone,
  ee as Timeline,
  ef as TimelineController,
  eQ as ToolLink,
  aY as TooltipOfDisabled,
  Tracker,
  c_ as TransformPatches,
  dh as Translate,
  ch as UniversalArrayInput,
  eY as UpsellDescriptionSerializer,
  eV as UpsellDialogDismissed,
  eX as UpsellDialogLearnMoreCtaClicked,
  eW as UpsellDialogUpgradeCtaClicked,
  eU as UpsellDialogViewed,
  ct as UrlInput,
  a$ as UserAvatar,
  fg as UserColorManagerProvider,
  bA as ValueError,
  ca as VirtualizerScrollInstanceContext,
  cc as VirtualizerScrollInstanceProvider,
  WithReferringDocuments,
  f0 as WorkspaceLoader,
  eZ as WorkspaceProvider,
  f7 as WorkspacesContext,
  f8 as WorkspacesProvider,
  ZIndexProvider,
  ej as __tmp_wrap_presenceStore,
  dA as _createAuthStore,
  _isCustomDocumentTypeDefinition,
  _isSanityDocumentTypeDefinition,
  ez as _useColorSchemeInternalValue,
  fF as asLoadable,
  buildLegacyTheme,
  dQ as checkoutPair,
  fs as collate,
  dB as createAuthStore,
  dO as createBufferedDocument,
  createConfig,
  dH as createConnectionStatusStore,
  dv as createDocumentPreviewStore,
  dW as createDocumentStore,
  fp as createDraftFrom,
  e8 as createGrantsStore,
  ed as createHistoryStore,
  fh as createHookFromObservableFactory,
  dz as createKeyValueStore,
  createMockAuthStore,
  createNoopTrackerScope,
  dP as createObservableBufferedDocument,
  createPatchChannel,
  createPlugin,
  ek as createProjectStore,
  fr as createPublishedFrom,
  dx as createSchema,
  fx as createSharedResizeObserver,
  createSourceFromConfig,
  aT as createTrackerScope,
  aU as createUseReporter,
  ff as createUserColorManager,
  en as createUserStore,
  ...
  d7 as defineLocale,
  d8 as defineLocaleResourceBundle,
  d9 as defineLocalesResources,
  definePlugin,
  eD as defineSearchFilter,
  eE as defineSearchFilterOperators,
  eL as defineSearchOperator,
  cF as diffMatchPatch,
  diffResolver,
  b8 as documentFieldActionsReducer,
  fj as documentIdEquals,
  dR as editState,
  dS as emitOperation,
  encodePath,
  fz as escapeField,
  fy as fieldNeedsEscape,
  bL as findIndex,
  b9 as flattenConfig,
  fromMutationPatches,
  bf as getAnnotationAtPath,
  getAnnotationColor,
  getConfigContextFromSource,
  bg as getDiffAtPath,
  e2 as getDocumentPairPermissions,
  e5 as getDocumentValuePermissions,
  fo as getDraftId,
  getExpandOperations,
  fm as getIdPair,
  dZ as getInitialValueStream,
  bS as getItemKey,
  bT as getItemKeySegment,
  f2 as getNamelessWorkspaceIdentifier,
  dX as getPairListener,
  dq as getPreviewPaths,
  dr as getPreviewStateObservable,
  ds as getPreviewValueWithFallback,
  dC as getProviderTitle,
  getPublishedId,
  dy as getSchemaTypeTitle,
  e9 as getTemplatePermissions,
  bK as getValueAtPath,
  bV as getValueError,
  f1 as getWorkspaceIdentifier,
  fv as globalScope,
  grantsPermissionOn,
  cG as inc,
  b7 as initialDocumentFieldActions,
  cC as insert,
  bG as isAddedItemDiff,
  isArray,
  cX as isArrayOfBlocksInputProps,
  cW as isArrayOfObjectsInputProps,
  cY as isArrayOfPrimitivesInputProps,
  dD as isAuthStore,
  cV as isBooleanInputProps,
  isBuilder,
  dE as isCookielessCompatibleLoginMethod,
  bc as isDev,
  fk as isDraft,
  fl as isDraftId,
  bU as isEmptyObject,
  ...
  cU as isNumberInputProps,
  cS as isObjectInputProps,
  cR as isObjectItemProps,
  bd as isProd,
  fn as isPublishedId,
  isRecord,
  bH as isRemovedItemDiff,
  fw as isString,
  cT as isStringInputProps,
  isTruthy,
  bI as isUnchangedDiff,
  fA as joinPath,
  d_ as listenQuery,
  er as matchWorkspace,
  fq as newDraftFrom,
  bD as noop,
  bO as normalizeIndexSegment,
  bQ as normalizeIndexTupleSegment,
  bP as normalizeKeySegment,
  bN as normalizePathSegment,
  dG as onRetry,
  dT as operationEvents,
  eK as operatorDefinitions,
  pathToString,
  bR as pathsAreEqual,
  cI as prefixPath,
  prepareConfig,
  dt as prepareForPreview,
  prepareTemplates,
  remoteSnapshots,
  ft as removeDupes,
  ec as removeMissingReferences,
  da as removeUndefinedLocaleResources,
  renderStudio,
  resizeObserver,
  resolveConditionalProperty,
  resolveConfig,
  bJ as resolveDiffComponent,
  fa as resolveInitialObjectValue,
  fb as resolveInitialValue,
  fc as resolveInitialValueForType,
  ba as resolveSchemaTypes,
  cD as set,
  setAtPath,
  cB as setIfMissing,
  fC as sliceString,
  ...
  fB as supportsTouch,
  toMutationPatches,
  fD as truncateString,
  uncaughtErrorHandler,
  cE as unset,
  dw as unstable_useValuePreview,
  df as usEnglishLocale,
  es as useActiveWorkspace,
  useAddonDataset,
  bi as useAnnotationColor,
  useClient,
  eB as useColorScheme,
  eC as useColorSchemeOptions,
  ey as useColorSchemeSetValue,
  eA as useColorSchemeValue,
  useConfigContextFromSource,
  useConnectionState,
  dL as useConnectionStatusStore,
  useCurrentLocale,
  useCurrentUser,
  c$ as useDataset,
  d0 as useDateTimeFormat,
  c6 as useDidUpdate,
  bj as useDiffAnnotationColor,
  be as useDocumentChange,
  d1 as useDocumentOperation,
  useDocumentOperationEvent,
  e4 as useDocumentPairPermissions,
  e3 as useDocumentPairPermissionsFromHookFactory,
  eg as useDocumentPresence,
  dK as useDocumentPreviewStore,
  useDocumentStore,
  useDocumentType,
  e7 as useDocumentValuePermissions,
  e6 as useDocumentValuePermissionsFromHookFactory,
  dY as useDocumentValues,
  useEditState,
  d2 as useFeatureEnabled,
  c4 as useFieldActions,
  cZ as useFormBuilder,
  cK as useFormCallbacks,
  useFormState,
  c0 as useFormValue,
  useFormattedDuration,
  dd as useGetI18nText,
  eh as useGlobalPresence,
  dJ as useGrantsStore,
  useHistoryStore,
  c5 as useHoveredField,
  de as useI18nText,
  d$ as useInitialValue,
  e0 as useInitialValueResolverContext,
  dN as useKeyValueStore,
  useListFormat,
  fE as useLoadable,
  a as useLocale,
  b4 as useMiddlewareComponents,
  useNumberFormat,
  useOnScroll,
  dM as usePresenceStore,
  aH as usePreviewCard,
  useProject,
  useProjectDatasets,
  d3 as useProjectId,
  useProjectStore,
  cL as useReferenceInputOptions,
  useRelativeTime,
  useReportedValues,
  useReporter,
  e1 as useResolveInitialValueForType,
  em as useResourceCache,
  useReviewChanges,
  aV as useRovingFocus,
  d4 as useSchema,
  eJ as useSearchState,
  useSource,
  useSyncState,
  eb as useTemplatePermissions,
  ea as useTemplatePermissionsFromHookFactory,
  d5 as useTemplates,
  ...
  useUserStore,
  useValidationStatus,
  cb as useVirtualizerScrollInstance,
  useWorkspace,
  e$ as useWorkspaceLoader,
  f3 as useWorkspaces,
  b0 as useZIndex,
  fG as userHasRole,
  f6 as validateBasePaths,
  ay as validateDocument,
  f5 as validateNames,
  f4 as validateWorkspaces,
  dV as validation,
  bh as visitDiff
};
