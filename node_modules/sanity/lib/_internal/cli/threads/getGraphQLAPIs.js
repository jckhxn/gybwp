"use strict";
var isPlainObject = require("lodash/isPlainObject.js"), oneline = require("oneline"), worker_threads = require("worker_threads"), getStudioWorkspaces = require("../../../_chunks-cjs/getStudioWorkspaces.js");
...
async function getGraphQLAPIsForked(parent) {
  const { cliConfig, cliConfigPath, workDir } = worker_threads.workerData, resolved = await resolveGraphQLApis({ cliConfig, cliConfigPath, workDir });
