...
export function Newsletter({ section }: NewsletterProps) {
  ...
  const textClass = backgroundColor === 'dark' || backgroundColor === 'primary' 
    ? 'text-white' 
    : 'text-gray-900'

  const subtitleClass = backgroundColor === 'dark' || backgroundColor === 'primary'
    ? 'text-gray-200'
    : 'text-gray-600'
    ...
    <section className={`py-16 ${backgroundClass}`}>
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className={`text-lg mb-8 ${subtitleClass}`}>
            {subtitle}
          </p>
