        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-8 mb-12">
            ...
            <div className="flex-1">
              ...
              {person.role === "host-consultant" &&
                person.consultingProfile?.calendarLink && (
                  <div className="mt-6">
                    <Link
          ...
          {/* Expertise/Skills */}
          {person.consultingProfile?.expertise &&
            person.consultingProfile.expertise.length > 0 && (
              <div className="mb-12">
          ...
          {showEpisodes && (
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">
                {person.role === "host-consultant"
                  ? "Recent Episodes"
                  : "Episodes Featuring " + person.name}
              </h3>
              <div className="text-center py-8">
                <p className="text-gray-500">
                  Episodes will be displayed here once episode data is connected
                </p>
              </div>
            </div>
          )}
