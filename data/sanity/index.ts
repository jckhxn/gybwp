import { PagePayload, EpisodePayload, PersonPayload, SponsorPayload } from '@/types'
...
export async function loadPage(pathname: string) {
  return loadQuery<PagePayload | EpisodePayload | PersonPayload | SponsorPayload | null>({
    query: PAGE_QUERY,
    params: { pathname },
